...
class HostsParser
{
    ...
    /**
     * @var int Variable for calculate prepare + render time
     */
    private $time_start = 0;

    /**
     * @var array Array for store all hosts data
     */
    private $hosts = array();

    /**
     * @var array Array for sources links
     */
    private $sources_list = array();

    /**
     * @var array Array for hosts exceptions
     */
